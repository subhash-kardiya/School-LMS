        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded p-4">
                    ...
                    <div class="row">
                        <div class="col-md-4"><small
                                class="text-muted">Class</small><br><strong><?php echo e($child?->class?->name ?? 'N/A'); ?></strong>
                        </div>
                        <div class="col-md-4"><small class="text-muted">Roll
                                Number</small><br><strong><?php echo e($child?->roll_no ?? 'N/A'); ?></strong></div>
                        <div class="col-md-4"><small
                                class="text-muted">Section</small><br><strong><?php echo e($child?->section?->name ?? 'N/A'); ?></strong>
                        </div>
                        <div class="col-md-4 mt-2"><small class="text-muted">Academic
                                Year</small><br><strong><?php echo e($child?->academicYear?->name ?? 'N/A'); ?></strong></div>
                    </div>
